...
import com.abinaya.greenthumb.android.MultipartUtility;
...
import com.abinaya.greenthumb.android.adapters.PlantRecordableTileArrayAdapter;
import com.abinaya.greenthumb.android.adapters.PlantTileRecyclerViewAdapter;
...
import com.abinaya.greenthumb.tracker.interf.IDialogHandler;
...
public class GreenThumbUi extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_thumb_ui);
...
//                    "currentDisplayArray");
        ...
        switch (requestCode) {
            case AndroidConstants.ACTIVITY_GENERIC_RECORD:
                if (resultCode == Activity.RESULT_OK) {
                    Bitmap image = (Bitmap) returnedIntent.getExtras().get("data");
            ...
            case AndroidConstants.ACTIVITY_IMPORT_CHOOSER:
                if (resultCode == Activity.RESULT_OK)   {
                    ...
                    updateMainActivityView();
                    Toast.makeText(GreenThumbUi.this, "Finished plant import.",
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.green_thumb_ui, menu);
        individualPlantMenu = menu;
        individualPlantMenu.setGroupVisible(0, false);
        individualPlantMenu.setGroupVisible(1, false);

        // activate some stuff if we're looking at the individual plant view
        if (switcher.getCurrentView() == individualPlantView && individualPlantMenu != null) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_rename) {
            AndroidUtility.presentRenameDialog(GreenThumbUi.this, tracker, currentPlant, new ICallback() {
                @Override
                public void callback() {
                    fillIndividualPlantView();
                }
            });
        } else if (id == R.id.action_delete_plant_really) {
            tracker.deletePlant(currentPlant);
            switchToPlantList();
        } else if (id == R.id.action_archive_plant) {
            currentPlant.archivePlant();
        } else if (id == R.id.action_unarchive_plant) {
            currentPlant.unarchivePlant();
        } else if (id == R.id.action_clone_plant) {
            presentAddPlantDialog(currentPlant.getPlantId());
        } else if (id == R.id.action_change_start_date) {
            presentChangePlantStartDateDialog();
        } else if (id == R.id.add_group) {
            presentAddGroupDialog(GreenThumbUi.this, tracker, new ICallback() {
                @Override
                public void callback() {
                    refreshDrawerGroups();
                }
    ...
    private void presentAddGroupDialog(GreenThumbUi greenThumbUi, PlantTracker tracker, ICallback iCallback) {
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        /*
                    <item
                android:id="@+id/nav_archived_plants"
                android:icon="@drawable/ic_growing_plant"
                android:title="@string/drawer_item_archived" /> in activity_green_thumb_ui_drawer

                || id == R.id.nav_archived_plants

        */
        if (id == R.id.nav_all_plants || id == R.id.nav_active_plants) {
            ...
            startSync(false);
        } else if (id == R.id.nav_full_sync) {
            startSync(true);
        } else if (id == R.id.nav_manage_events) {
            Intent manageRecordTemplates = new Intent(GreenThumbUi.this, ManageRecordTemplates.class);

            // TODO pass data
            // manageRecordTemplates.putExtra("tracker", tracker);

            startActivityForResult(manageRecordTemplates, AndroidConstants.ACTIVITY_MANAGE_RECORD_TEMPLATES);
        } else if (id == R.id.nav_delete) {
            AlertDialog alert = AndroidUtility.presentDeleteAllPlantsDialog(GreenThumbUi.this, new ICallback() {
                @Override
                public void callback() {
        ...
        } else if (id == R.id.nav_about_privacy_policy) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.freeprivacypolicy.com/live/26fda8c4-289c-409e-86b7-d973aceb28df"));
            startActivity(browserIntent);
        } else if (id == R.id.nav_about_plant_tracker) {
            presentAboutDialog();
        } /*else if (id == R.id.nav_about_profile) {
    ...
    private void startSync(boolean fullSync) {
        ...
        if (syncAddress != null) {
            ...
            Toast.makeText(GreenThumbUi.this, "You must set a Sync Address in Sync Settings first!",
    ...
    private void bindIndividualPlantView() {
        ...
        recordableEventListView.addItemDecoration(new DividerItemDecoration(
                GreenThumbUi.this, DividerItemDecoration.VERTICAL));
    ...
    */
    ...
    private void fillViewWithPlants() {
        ...
        PlantTileRecyclerViewAdapter adapter = new PlantTileRecyclerViewAdapter(
                GreenThumbUi.this, currentDisplayArray,
                new IAction<Plant>() {
    ...
    public void fillIndividualPlantView() {
            ...
            if (thumbnail != null)  {
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        GreenThumbUi.this.runOnUiThread(updateUi);
                    }
                };
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (selectedItem) {
                    ...
                    case CREATE_NEW_GENERIC_RECORD_OPTION:
                        Intent intent = new Intent(GreenThumbUi.this,
        ...
        PlantRecordableTileArrayAdapter plantRecordableAdapter =
                new PlantRecordableTileArrayAdapter(GreenThumbUi.this,
    ...
    private void launchCollectPlantDataIntent(GenericRecord record, boolean showNotes) {
        Intent intent = new Intent(GreenThumbUi.this, CollectPlantData.class);
    ...
    private void switchToPlantList() {
        parentPlantViewStack.clear();
        Intent intent = new Intent(GreenThumbUi.this, GreenThumbUi.class);
        startActivity(intent);
    }
    ...
    private void presentGenericEventDialog(final int layoutId, IDialogHandler dialogHandler) {
        final Dialog dialog = new Dialog(GreenThumbUi.this);
    ...
    private void presentCopyDialog()    {
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dialog.dismiss();
                Toast.makeText(GreenThumbUi.this,
...
//        Toast.makeText(getBaseContext(), "Created reminder for 60s from now...", Toast.LENGTH_LONG).show();
    ...
    private void syncWithPrivateStash(String host, boolean forceFullSync) {
        ...
        if (masterJsonUploadList.size() == 0 && masterImageUploadList.size() == 0) {
            Toast.makeText(GreenThumbUi.this, "No plant data to sync.",
                    Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                Runnable updateUi = new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(GreenThumbUi.this, "Finished plant data sync.",
                                Toast.LENGTH_SHORT).show();
                    }
                };
