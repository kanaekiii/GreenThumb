...
import com.abinaya.greenthumb.android.activities.ImageSeriesViewer;
import com.abinaya.greenthumb.android.activities.GreenThumbUi;
...
public class PlantRecordableTileArrayAdapter extends
            ...
            public boolean onLongClick(View v) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.delete_from_here) {
                            displayDeleteFromHereConfirm(selectedRecord);
                            return true;
                        } else if (item.getItemId() == R.id.delete_from_all) {
    ...
    private void displayDeleteFromHereConfirm(GenericRecord rec) {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                ((GreenThumbUi)context).fillIndividualPlantView();
                dialog.dismiss();
            }
        });
    ...
    private void displayDeleteFromAllConfirm(GenericRecord rec)  {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ((GreenThumbUi)context).deleteRecordFromAllPlants(rec);
                ((GreenThumbUi)context).fillIndividualPlantView();
                dialog.dismiss();
            }
        });
